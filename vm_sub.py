...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("ryanhlee/ipinfo")
    client.subscribe("ryanhlee/date")
    client.subscribe("ryanhlee/time")
    
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("ryanhlee/ipinfo", on_message_from_ipinfo)
    client.message_callback_add("ryanhlee/date", on_message_from_date)
    client.message_callback_add("ryanhlee/time", on_message_from_time)
